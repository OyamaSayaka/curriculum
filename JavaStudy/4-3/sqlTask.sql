...
SELECT AVG(goods_price) FROM goods_table 
...
SELECT 
stock_table.store_code

FROM
stock_table
WHERE 
quantity > (SELECT AVG(quantity) FROM stock_table WHERE store_code = 'EA01')
